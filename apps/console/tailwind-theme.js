...
export default {
  ...
  'family:box': {
    decorator:
      'block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-400 peer-checked:ring-cblue-500 peer-checked:ring-2 text-transparent peer-checked:text-cblue-500',
    decoratorIcon:
      'flex w-full h-full absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 [&>svg]:stroke-2',
    help: 'mb-2 mt-1.5',
    input:
      'absolute w-0 h-0 overflow-hidden opacity-0 pointer-events-none peer',
    inner: '$remove:formkit-disabled:bg-gray-200',
    label: '$reset text-sm text-inherit mt-1 select-none',
    wrapper: 'flex items-center mb-1',
    legend: 'px-2',
  },
  'family:button': {
    input:
      '$reset inline-flex items-center bg-cblue-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-cblue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
    wrapper: 'mb-1',
  ...
  'family:dropdown': {
    ...
    inner:
      'max-w-md relative flex ring-1 ring-gray-400 focus-within:ring-cblue-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-400 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-cblue-500',
    input: 'w-full px-3 py-2',
    listbox: 'bg-white shadow-lg rounded overflow-hidden',
    listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
    listitem:
      'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-cblue-600 aria-selected:bg-cblue-600 aria-selected:text-white',
    loaderIcon: 'ml-auto',
    loadMoreInner:
      'flex items-center justify-center text-sm p-2 text-center w-full text-cblue-500 formkit-loading:text-gray-500 cursor-pointer [&>span]:mr-3 [&>span]:ml-0',
    option: 'p-2.5',
  ...
  'family:text': {
    inner:
      'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-cblue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-cblue-500 rounded mb-1',
    input:
      'w-full px-3 py-2 border-none text-base text-inherit placeholder-gray-400 formkit-disabled:dark:text-zinc-600',
  },
  'family:date': {
    inner:
      'flex items-center max-w-md ring-1 ring-gray-400 focus-within:ring-cblue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-cblue-500 rounded mb-1',
  ...
  file: {
    ...
    fileRemove:
      'relative z-[2] ml-auto text-[0px] hover:text-red-500 pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-cblue-500 peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]',
  ...
  select: {
    inner:
      'flex relative max-w-md items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-cblue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-cblue-500',
    input:
  ...
  textarea: {
    inner:
      'flex max-w-md rounded mb-1 ring-1 ring-gray-400 focus-within:ring-cblue-500 [&>label:first-child]:focus-within:text-cblue-500',
    input:
  ...
  datepicker: {
    ...
    month: `
      ...
      bg-gray-200
      aria-selected:bg-cblue-500 aria-selected:text-white
      focus:outline focus:outline-2 focus:outline-cblue-500 focus:outline-offset-2 focus:bg-white focus:text-black
    ...
    `,
    timeInput:
      'w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-cblue-500',
    ...
    dayButton:
      'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-cblue-500',
    monthButton:
      'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-cblue-500',
    yearButton:
      'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-cblue-500',
    ...
    openButton: `
      ...
      focus-visible:outline-none focus-visible:text-white focus-visible:bg-cblue-500
    `,
    calendarIcon:
  ...
  repeater: {
    ...
    downControl:
      'hover:text-cblue-500 disabled:hover:text-inherit disabled:opacity-25',
    fieldset: 'py-4 px-5',
    help: 'mb-2 mt-1.5',
  ...
  slider: {
    ...
    fill: 'h-full rounded-full absolute top-0 mx-[-4px] bg-cblue-500',
    ...
    handle:
      'group w-4 h-4 rounded-full bg-white absolute top-1/2 left-0 z-[2] -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:ring-2 ring-cblue-500 data-[is-target="true"]:z-[3]',
    tooltip:
      'absolute bottom-full left-1/2 -translate-x-1/2 -translate-y-[4px] bg-cblue-500 text-white py-1 px-2 text-xs leading-none whitespace-nowrap rounded-sm opacity-0 pointer-events-none transition-opacity after:content-[""] after:absolute after:top-full after:left-1/2 after:-translate-x-1/2 after:-translate-y-[1px] after:border-4 after:border-transparent after:border-t-cblue-500 group-hover:opacity-100 group-focus-visible:opacity-100 group-data-[show-tooltip="true"]:opacity-100',
  ...
  taglist: {
    ...
    tagWrapper:
      'mr-1 focus:outline-none focus:text-white [&>div]:focus:bg-cblue-500 [&>div>button]:focus:text-white',
    tagLabel: 'pl-2 pr-1',
  ...
  toggle: {
    ...
    track:
      'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-cblue-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
    valueLabel: 'font-bold text-sm',
    wrapper: 'flex flex-wrap items-center mb-1',
  },
  transferlist: {
    outer: `
      [&_.dnd-placeholder]:bg-cblue-500 [&_.dnd-placeholder]:text-white
